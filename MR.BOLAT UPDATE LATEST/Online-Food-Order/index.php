...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li ><a href="#" style="color:white;"><span class="glyphicon glyphicon-user" style="color:white;"></span> Welcome <?php echo $_SESSION['login_user1']; ?> </a></li>
            <li class="active"><a href="myrestaurant.php" style="color:white;">MANAGER CONTROL PANEL</a></li>
            <li><a href="logout_m.php" style="color:white;"><span class="glyphicon glyphicon-log-out" style="color:white;"></span> Log Out </a></li>
          </ul>
<?php
}
  ...
  ?>
           ...
           <ul class=" nav navbar-nav navbar-light navbar-right " >
            <li ><a href="#" style="color:white;"><span class="glyphicon glyphicon-user" style="color:white;"></span> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            <li class="active"><a href="foodlist.php" style="color:white;"><span class="glyphicon glyphicon-cutlery" style="color:white;"></span> Food Zone </a></li>
            <li><a href="cart.php" style="color:white;"><span class="glyphicon glyphicon-shopping-cart" style="color:white;"></span> Cart
              (<?php
            ...
            <li><a href="logout_u.php" style="color:white;"><span class="glyphicon glyphicon-log-out" style="color:white;"></span> Log Out </a></li>
          </ul>
  <?php        
}
else {
...
?>
    ...
    <br>
    <div class="orderblock" style="color: red;">
