      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="contactus.php" style="color:white;">Contact Us</a></li>
          </ul>
...
?>
    ...
    <div class="heading" style="background-color: #ffcb0c;">
     <strong>Want to contact <span class="edit" style="color: red;"> Mr. Bolat </span>?</strong>
     <br>
