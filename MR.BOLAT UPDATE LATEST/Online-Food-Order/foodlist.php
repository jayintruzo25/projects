...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class="glyphicon glyphicon-user" style="color:white;"></span> <span style="color:white;">Welcome <?php echo $_SESSION['login_user1']; ?> </span></a></li>
            <li><a href="myrestaurant.php" style="color: white;">MANAGER CONTROL PANEL</a></li>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#" style="color: white;"><span class="glyphicon glyphicon-user" style="color:white;"></span><span> Welcome <?php echo $_SESSION['login_user2']; ?></span></a></li>
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food Zone </a></li>
            <li><a href="cart.php" style="color:white;"><span class="glyphicon glyphicon-shopping-cart" style="color:white;"></span> Cart  (<?php
